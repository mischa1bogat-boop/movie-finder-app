...
export default function Hero(props: HeroProps) {
    ...
    return (
        <div className={`w-[100%] relative overflow-hidden pt-32 pb-6 px-24 mx-auto flex flex-col items-center gap-6 ${isDark ? 'bg-gradient-to-b from-amber-800 to-black' : 'bg-gradient-to-b from-amber-400 to-white'}`}>
            <div className="w-120 h-120 bg-purple-600/60 rounded-full bottom-60 pointer-events-none absolute blur-[100px]"></div>
            <h1 className="text-3xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">{heroText}<span className="animate-pulse">|</span>
            </h1>
